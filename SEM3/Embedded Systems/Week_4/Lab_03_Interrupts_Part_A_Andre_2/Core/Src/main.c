...
/**
  ...
  * @summary
  *
  * The objective of this assignment is to create a handler function that handles
  * button external interrupts. In this assignment, a button will execute an external
  * interrupt when it is pressed. The duration of the pressed button will either
