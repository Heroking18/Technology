...
/**
  ...
  * using system timer. In part B of the assignment, requires most of the code
  * in part A. The only difference is SysTick interrupt
  * is used instead of SysTick counter flag to make a delay.
  *
  * @attention
  *
